...
public class PrivacyPolicyTest extends BaseTest {
    ...
    public String policyVersionData = "This version was approved by Amanda Keton on June 7, 2021, pursuant to the Delegation of policy-making authority by the Board, and went into effect on June 25, 2021. Previous versions can be found below:";
    public String policyVersionDataShort = "on June 7, 2021, pursuant to the ";
    public String result="Privacy Policy\n"+"This is a summary of the Privacy Policy. To read the full terms, scroll down or click here.\n" +
    ...
    public void PrivacyTestVersionCheck() {
        ...
        Assertions.assertTrue(driver.findElement(privacyPolicyPage.presentPolicy).getText().contains(policyVersionDataShort));
        Assertions.assertEquals(policyVersionData,driver.findElement(privacyPolicyPage.presentPolicy).getText().trim());
    }
